...
| 7.| [Entertainment application](...)| For an entertainment application to find out the cause of losses| python, pandas, seaborn, matpotlib,  histogram, boxplot, scattermatrix, statistical test, LTV, CAC, cohort analysis| Russian, English|
